local locales = {
	...
	["frFR"] = {
		...
		["Copy"] = "Copier", -- Needs review
		["Copy other profile to current profile:"] = "Copie un profile vers le profile courant", -- Needs review
		["Current profile: [%s]"] = "Profile courrant : [%s]", -- Needs review
		["Data from '%s' has been successfully copied to '%s'"] = "Les données de '%s' ont été copiées vers '%s'", -- Needs review
		["Delete"] = "Effacer", -- Needs review
		["Delete profile:"] = "Effacer le profile :", -- Needs review
		["Disable test mode"] = "Éteindre le mode test", -- Needs review
		["Enable test mode (need at least one visible nameplate)"] = "Allumer le mode test\r\n(nécessite au moins une étiquette de nom visible)", -- Needs review
		["General"] = "Général", -- Needs review
		["Icon size"] = "Taille de l'icone", -- Needs review
		["Icon X-coord offset"] = "Icon X-coord offset", -- Needs review
		["Icon Y-coord offset"] = "Icon Y-coord offset", -- Needs review
		["MISC"] = "Divers", -- Needs review
		["New spell has been added: %s"] = "Un nouveau sort a été ajouté : %s", -- Needs review
		["Options are not available in combat!"] = "Les options sont indisponibles durant un combat", -- Needs review
