...
(comma-separated)]=],
		...
		["options:category:text"] = "Text",
		["anchor-point:top"] = "Top",
		["anchor-point:topleft"] = "Top left",
		["anchor-point:topright"] = "Top right",
		["anchor-point:right"] = "Right",
		["anchor-point:left"] = "Left",
		["anchor-point:bottom"] = "Bottom",
		["anchor-point:bottomleft"] = "Bottom left",
		["anchor-point:bottomright"] = "Bottom right",
		["anchor-point:x-offset"] = "X offset",
		["anchor-point:y-offset"] = "Y offset",
		["anchor-point:center"] = "Center",
		["options:text:font"] = "Font",
		["options:text:font-scale"] = "Font scale",
		["options:text:font-size"] = "Font size",
		["options:timer-text:scale-font-size"] = [=[Scale font size
according to
icon size]=],
...
(разделять запятыми)]=],
		...
		["options:category:text"] = "Текст",
		["anchor-point:top"] = "Сверху",
		["anchor-point:topleft"] = "Сверху слева",
		["anchor-point:topright"] = "Сверху справа",
		["anchor-point:right"] = "Справа",
		["anchor-point:left"] = "Слева",
		["anchor-point:bottom"] = "Снизу",
		["anchor-point:bottomleft"] = "Снизу слева",
		["anchor-point:bottomright"] = "Снизу справа",
		["anchor-point:x-offset"] = "Смещение по X",
		["anchor-point:y-offset"] = "Смещение по Y",
		["anchor-point:center"] = "Центр",
		["options:text:font"] = "Шрифт",
		["options:text:font-scale"] = "Масштаб шрифта",
		["options:text:font-size"] = "Размер шрифта",
		["options:timer-text:scale-font-size"] = [=[Scale font size
according to
icon size]=],
